...
class Onyphe:
    ...
    def synscan(self, ip):
        ...
        """
        return self._prepare_request(
            "/".join([self.version, "synscan", ip]), method="get"
        )
    ...
    def summary_ip(self, ip):
        ...
        """
        return self._prepare_request(
            "/".join([self.version, "summary/ip", ip]), method="get"
        )
    ...
    def summary_hostname(self, hostname):
        ...
        """
        return self._prepare_request(
            "/".join([self.version, "summary/hostname", hostname]), method="get"
        )
    ...
    def simple_datascan_datamd5(self, data_md5):
        ...
        """
        return self._prepare_request(
            "/".join([self.version, "simple/datascan/datamd5", data_md5]), method="get"
        )
    ...
    def alert_list(self):
        ...
        """
        return self._prepare_request(
            "/".join([self.version, "alert/list"]), method="get"
        )
    ...
    def add_alert(self, query, name, email):
        ...
        if query and name and email:
            ...
            return self._prepare_request(
                "/".join([self.version, "alert/add"]), method="post", json_data=data
            )
        else:
    ...
    def del_alert(self, id_alert):
        ...
        if id_alert:
            return self._prepare_request(
                "/".join([self.version, "alert/del", id_alert]), method="post"
            )
        else:
